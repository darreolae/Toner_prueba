...
<html>
	<head>
		...
		<link rel="stylesheet" href="toner.css?v=<?php echo (rand());  ?>">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
	...
	<body>
		<div id="reg_toner">
			...
			<form action="impresoras.php">
				<tr>
				<td><td><center><input id="impresora" class="impresora" type="submit" name="impresora" value="APARTADO IMPRESORAS"></td></td>
				</tr>
			</form>

			<form action="baja_toner.php">
				<blockquote><tr>
					<td><label>Modelo</label></td>
					<td><input type="text" name="baja"placeholder = "modelo" required></td>
				</tr></blockquote>
				<tr>
				<td><td><center><input id="baja" class="baja" type="submit" name="baja" value="Dar de baja toner"></td></td>
				</tr>
			</form>
	...
	<head>
		<tittle><center><h1 id="titulo" class="titulo">REGISTRADOS</h1></tittle>
		</head>
		<body>
